 ...
 */
public class BeatBoxRecycleViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{
    public Button mSoundName;
    public MyItemClickListener mClickListener;
    public MyItemLongClickListener mLongClickListener;

    public BeatBoxRecycleViewHolder(View itemView, MyItemClickListener mClickListener, MyItemLongClickListener mLongClickListener) {
        super(itemView);
